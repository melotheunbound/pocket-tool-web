          ...
          <article className="docs-content">
            <section id="getting-started" className="docs-section docs-intro">
              ...
              <div className="docs-steps">
                <article data-reveal style={{ "--delay": "0ms" } as React.CSSProperties}><span>1</span><div><h3>Add Pocket Tool</h3><p>Use Discord&apos;s authorization screen to install Pocket Tool.</p></div></article>
                <article data-reveal style={{ "--delay": "70ms" } as React.CSSProperties}><span>2</span><div><h3>Type a command</h3><p>Start with <code>/help</code>, or jump straight to something useful like <code>/timestamp</code>.</p></div></article>
                <article data-reveal style={{ "--delay": "140ms" } as React.CSSProperties}><span>3</span><div><h3>Try message tools</h3><p>Open a message’s Apps menu to quote, translate, transcribe or turn content into a GIF.</p></div></article>
              </div>
            ...
            <section id="install-anywhere" className="docs-section">
              ...
              <div className="info-grid">
                <article data-reveal style={{ "--delay": "0ms" } as React.CSSProperties}><span>INSTALL</span><h3>Add it to your account</h3><p>Pocket Tool follows your Discord account instead of being installed to one server.</p></article>
                <article data-reveal style={{ "--delay": "70ms" } as React.CSSProperties}><span>USE</span><h3>Bring it into any conversation</h3><p>Call its commands in DMs, private channels and servers that allow user-installed apps.</p></article>
              </div>
            ...
            <section id="featured" className="docs-section">
              ...
              <div className="workflow-docs">
                <article id="quote" data-reveal style={{ "--delay": "0ms" } as React.CSSProperties}>
                ...
                <article id="time" data-reveal style={{ "--delay": "60ms" } as React.CSSProperties}>
                ...
                <article id="tts" data-reveal style={{ "--delay": "120ms" } as React.CSSProperties}>
                ...
                <article id="tweet" data-reveal style={{ "--delay": "180ms" } as React.CSSProperties}>
            ...
            <section id="data" className="docs-section">
              ...
              <div className="policy-links">
                <Link href="/privacy" data-reveal style={{ "--delay": "0ms" } as React.CSSProperties}><span>Privacy Policy</span><b>Read Policy</b></Link>
                <Link href="/terms" data-reveal style={{ "--delay": "70ms" } as React.CSSProperties}><span>Terms of Service</span><b>Read Terms</b></Link>
              </div>
