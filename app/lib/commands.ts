...
export const fallbackCommands: Command[] = [
  { name: "/avatar", description: "View a user's avatar", syntax: "/avatar user: @member scope: Global", category: "Lookups", context: "Slash Command" },
  { name: "/banner", description: "View a user's banner", syntax: "/banner user: @member", category: "Lookups", context: "Slash Command" },
  { name: "/debug", description: "View stats and information about me!", syntax: "/debug", category: "Essentials", context: "Slash Command" },
  { name: "/gif", description: "Turn an image into a GIF", syntax: "/gif image: attachment", category: "Create & Media", context: "Slash Command" },
  { name: "/help", description: "View and search through all available commands", syntax: "/help", category: "Essentials", context: "Slash Command" },
  { name: "/invite", description: "View information about an invite", syntax: "/invite link: discord.gg/…", category: "Lookups", context: "Slash Command" },
  { name: "/ping", description: "Pong!", syntax: "/ping", category: "Essentials", context: "Slash Command" },
  { name: "/role", description: "View information about a role", syntax: "/role role: @role", category: "Lookups", context: "Slash Command" },
  { name: "/timestamp", description: "Generates a Discord-style timestamp for the given time", syntax: "/timestamp time: in 10 minutes timezone: Europe/London style: Relative Time", category: "Language & Time", context: "Slash Command" },
  { name: "/timezone", description: "View the current time for a specific timezone", syntax: "/timezone zone: America/New_York", category: "Language & Time", context: "Slash Command" },
  { name: "/translate", description: "Translates the given text into almost any language", syntax: "/translate text: … from: Detect Automatically to: Use My Locale", category: "Language & Time", context: "Slash Command" },
  { name: "/tts", description: "Converts text to speech", syntax: "/tts text: … voice: Neutral language: English", category: "Create & Media", context: "Slash Command" },
  { name: "/tweet", description: "Display a tweet preview", syntax: "/tweet url: … language: Use My Locale", category: "Language & Time", context: "Slash Command" },
  { name: "/user", description: "View information about a user or yourself", syntax: "/user user: @member scope: Guild", category: "Lookups", context: "Slash Command" },
  ...
  { name: "Quote This Message", description: "Create a quote card from a message", syntax: "Message menu -> Apps -> Quote This Message", category: "Create & Media", context: "Message Context Command" },
